...
public class VariableCalculationsTest {
	...
	public void addListCalculator() {
		...
		List<Integer> variables = calculations.translateAllVariables(Collections.singletonList(1));
	...
	public void listAndSingleValueWithDefault() {
		...
		VariableCalculations<Integer, Integer> calculations = builder
				...
				.build();
		List<Integer> variables = calculations.translateAllVariables(Arrays.asList(1, 2, 3));
