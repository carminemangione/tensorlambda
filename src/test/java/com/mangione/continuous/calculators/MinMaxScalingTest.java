...
public class MinMaxScalingTest {
	...
	public void minMaxScale() throws Exception {
		...
		assertEquals(0, minMaxScaling.apply(2., null).get(0), Double.MIN_VALUE);
		assertEquals(1, minMaxScaling.apply(4., null).get(0), Double.MIN_VALUE);
		assertEquals(0.5, minMaxScaling.apply(3., null).get(0), Double.MIN_VALUE);
	}
	...
	public void serialize() throws Exception {
		...
		assertEquals(0, reconstituted.apply(2., null).get(0), Double.MIN_VALUE);
		assertEquals(1, reconstituted.apply(4., null).get(0), Double.MIN_VALUE);
		assertEquals(0.5, reconstituted.apply(3., null).get(0), Double.MIN_VALUE);
	}
