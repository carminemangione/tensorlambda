...
public class SparseExemplarTest {
	...
	public void noValuesNoColumns() {
		SparseExemplar<Integer> sparseExemplar = new SparseExemplar<>(new Integer[]{0}, new int[]{0}, 5, 0, 0);
	...
	public void targetIndexAndValue() {
		SparseExemplar<Integer> sparseExemplar = new SparseExemplar<>(new Integer[]{3, 5, 10}, new int[]{1, 3, 4}, 5, 0, 3);
	...
	public void getFeaturesDoesNotIncludeTarget() {
		SparseExemplar<Integer> sparseExemplar = new SparseExemplar<>(new Integer[]{3, 5, 10, 11}, new int[]{1, 3, 4, 5}, 6, 666, 3);
	...
	public void valuesDoesNotContainTarget() {
		new SparseExemplar<>(new Integer[0], new int[0], 5, 0, 0);
	}
	...
	public void targetColumnNotInSparseInput() {
		new SparseExemplar<>(new Integer[]{0, 1}, new int[] {2, 10}, 3, 0, 3);
	}

	@Test(expected = IllegalArgumentException.class)
	public void targetColumnTooHighExcepts() {
		new SparseExemplar<>(new Integer[]{0, 1}, new int[] {2, 10}, 2, 0, 0);
	}
	...
	public void getValuesAtIndexLowerThanTarget() {
		SparseExemplar<Integer> sparseExemplar = new SparseExemplar<>(new Integer[]{3, 5, 10}, new int[]{1, 3, 4}, 5, 666, 3);
	...
	public void getFeatureTargetExcepts() {
		new SparseExemplar<>(new Integer[]{3, 5, 10, 11}, new int[]{1, 3, 4, 5}, 6, 666, 3).getFeature(3);
	}
